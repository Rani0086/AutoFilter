...
OWNER_ID = environ.get('OWNER_ID', '7008975700')
...
EVAL_ID = environ.get("EVAL_ID", "-1002474007326")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7008975700 7526369190').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '7526369190 6497757690 7008975700
').split()]
auth_channel = environ.get('AUTH_CHANNEL')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002474007326')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002354698655')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://I-LOVE-PDF-BOT:I-LOVE-PDF-BOT@cluster0.c51o3a9.mongodb.net/?retryWrites=true&w=majority")
...
BOT_USERNAME = environ.get("BOT_USERNAME", "Ng_Movies55_bot")
BOT_NAME = environ.get("BOT_NAME", "𝐋ᴜᴄʏ")
BOT_ID = environ.get("BOT_ID", "7745813306")
S_GROUP = environ.get('S_GROUP', "telugu_movies148")
S_CHANNEL = environ.get('S_CHANNEL', "telugu_movies148")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/telugu_movies148')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/telugu_movies148')
